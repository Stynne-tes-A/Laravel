  ...
  <main class="grid lg:grid-cols-12 gap-8 md:mt-10 ">
      ...
      <section>
        <ul class="flex overflow-x-auto scrollbar-hide items-center gap-2">
          ...
          @for ($i = 0; $i < 10; $i++) <li class="flex flex-col justify-center w-20 gap-1 p-2">
            <x-avatar wire:ignore story src="https://100k-faces.glitch.me/random-image-{{$i}}" class="h-14 w-14" />
    ...
    <aside class="lg:col-span-4   hidden lg:block p-4">
      ...
      <div class="flex items-center gap-2">
        ...
        <x-avatar wire:ignore src="https://100k-faces.glitch.me/random-image" class="w-12 h-12" />
        ...
        <ul class="my-2 space-y-3">
          ...
          <li class="flex items-center gap-3">
            <a  href="{{route('profile.home',$user->username)}}" >
              <x-avatar wire:ignore src="https://100k-faces.glitch.me/random-image-{{$key}}" class="w-12 h-12" />
            </a>
      ...
      <section class="mt-10">
        ...
        <h3 class="text-gray-800/90 mt-6 text-sm"> Momento </h3>
